...
export const normalizeBreed = (breed: CatBreed) => ({
  ...
  urls: {
    cfa: breed.cfa_url ?? null,
    vcahospitals: breed.vcahospitals_url ?? null,
    vetstreet: breed.vetstreet_url ?? null,
    wikipedia: breed.wikipedia_url ?? null,
  },
  stats: {
    adaptability: breed.adaptability ?? null,
    affectionLevel: breed.affection_level ?? null,
    bidability: breed.bidability ?? null,
    energyLevel: breed.energy_level ?? null,
    grooming: breed.grooming ?? null,
    health_issues: breed.health_issues ?? null,
    intelligence: breed.intelligence ?? null,
    sheddingLevel: breed.shedding_level ?? null,
